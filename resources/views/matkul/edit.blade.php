<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Mata Kuliah &raquo; {!! $matkul->nama_matkul !!} &raquo; Edit
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('matkul.update', ['matkul' => $matkul->id]) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-wrap">                      
                            <div class="w-full  self-center mt-2 px-3 lg:w-1/2">
                                ...
                                <input disabled value="{{ old('kode_matkul') ?? $matkul->kode_matkul }}" name="kode_matkul" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Kode Mata Kuliah">
                                <input value="{{ old('kode_matkul') ?? $matkul->kode_matkul }}" name="kode_matkul" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="hidden" placeholder="Kode Mata Kuliah">
                            </div>
                            ...
                            <div class="w-full  self-center mt-2 px-3 lg:w-1/2">
                                ...
                                <input value="{{ old('nama_matkul') ?? $matkul->nama_matkul }}" name="nama_matkul" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Nama Mata Kuliah">
                            </div>
                    </div>
                    ...
                    <div class="flex flex-wrap mt-10">
                        ...
                        <div class="w-full  self-center mt-2 px-3 lg:w-1/3">
                            ...
                            <select name="id_kompetensi" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name">
                                <option value="{{ $kompmatkul->id }}">{{ $kompmatkul->id }} - {{ $kompmatkul->profil }}</option>
